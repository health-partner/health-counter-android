...
import doyoung.practice.healthcounternew.databinding.FragmentLegBinding


class FragmentLeg: Fragment() {
    lateinit var binding: FragmentLegBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentLegBinding.inflate(inflater, container, false)
        return binding.root
    }
